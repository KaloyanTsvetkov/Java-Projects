...
VALUES 
   ...
   ('company2', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 
   '4a44dc15364204a80fe80e9039455cc1608281820fe2b24f1e5233ade6af1dd5', ''),
   ('company3', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 
   '4a44dc15364204a80fe80e9039455cc1608281820fe2b24f1e5233ade6af1dd5', '');
...
VALUES 
   ...
   'organisation', 0),
   (2, 'Gosho ET', 'Sofia city, blvd. Todor Aleksandrov 21A', 'Gosho Goshev', '123456789', 'gosho@abv.bg',
   'organisation', 0),
   (3, 'Dent AD', 'Pernik, ul. Yuri Gagarin 10', 'Ivan Ivanov', '121256347', 'dent@abv.bg',
   'organisation', 0);
   
INSERT INTO advertisements (CATEGORY_ID, TITLE, COMPANY_ID, CONTENT, TEST, PRICE, ACTIVITY_DAYS, EXPIRATION_DATE,
	PLACE_ID, IS_VIP, IS_APPROVED, IS_PAID, IS_EXPIRED, HAS_INVOICE)
VALUES 
   ...
   '', 100, 30, null, 1, true, false, false, false, false),
   ...
   '', 0, 30, null, 4, false, false, false, false, true),
   ...
   '', 100, 30, null, 2, true, false, false, false, true),
   (6, 'Dutch Technical Support Representative', 2, 'Currently we are looking for Windows support engineers to be trained into various data backup and restore tools and become BACKUP AND RECOVERY ENGINEERS, providing remote server and application support to HP customers.',
   '', 100, 30, null, 4, true, false, false, false, false),
   (4, 'Social Media Manager', 3, 'Deep analytical skills. Good advisory skills. Good management skills (setting clear objectives and managing priorities)Self-management and self-organization.',
   '', 100, 30, null, 3, true, false, false, false, false),
   (3, 'International Account Manager', 3, 'Virtual Affairs is looking for an enthusiastic and well-organized Office Manager for our Sofia office. Joining us you will be able to work within a team of highly motivated professionals and have different opportunities for career and personal growth.',
   '', 100, 30, null, 5, true, false, false, false, false);
