...
public class ManagedBeanForInvoices {
	...
	public void exportToExcelShowAll() {
		setFileName("allInvoices" + ejbInvoice.getCurrentDate());
	...
	public void exportToExcelByExpectingPayments() {
		setFileName("byExpectingPayments" + ejbInvoice.getCurrentDate());
		Export export = new Export(getFileName());
	...
	private void generateMssgForFile(boolean successExport) {
		if (successExport) {
			setMssg(fileName + ".xls has been successfully written to D:\\");
		} else {
			setMssg(fileName + ".xls has NOT been successfully written to D:\\");
		}
	}
